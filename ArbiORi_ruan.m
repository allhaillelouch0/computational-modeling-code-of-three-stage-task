...
for d= 1 : maxd
    ...
    for i = 1 : 1 : maxi
        ...
        data_in{1,1}.model_BayesArb = model_BayesArb;
        data_in{1,1}.mode = mode;
        SBJ = data_in{1,1};
        save(['result_save_ruan/' 'SBJ_' list_sbj{i} '_' num2str(t(1)), num2str(t(2)), num2str(t(3)),num2str(t(4)) '.mat'],'SBJ')
